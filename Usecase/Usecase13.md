# USE CASE: 13 produce a report of the top populated cities in the continent by filter number of cities
...
* Organization's employee request report about cities information by filtering top populated cities in the continent.
